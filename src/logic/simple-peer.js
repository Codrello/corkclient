...
export class Peer extends Emitter {
        ...
        this._pc
            ...
            const onSuccess = () => {
                ...
                if (this.trickle || this._iceComplete)
                    ...
                    this.once('_iceComplete', sendOffer); // throw new Error("Method not implemented.") // this.once("_iceComplete", sendOffer) // wait for candidates
            };
            const onError = (err) => {
    ...
    _onIceStateChange() {
        ...
        log('iceStateChange (connection: %s) (gathering: %s)', iceConnectionState, iceGatheringState);
        ...
        const findCandidatePair = () => {
            ...
            this.getStats((err, items) => {
                ...
                const setSelectedCandidatePair = (selectedCandidatePair) => {
                    ...
                    log(`connect local: ${this.localAddress}:${this.localPort} remote: ${this.remoteAddress}:${this.remotePort}`);
                };
                items.forEach((item) => {
                    // Spec-compliant
