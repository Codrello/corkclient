...
const normalizeConfigName = (name) => name.toUpperCase().replace(/[-\ .]/gim, '_');
/**
 ...
 * 3. Default values
 */
export function getConfig(name, defaultValue, forceUpdate = false) {
...
export const SIGNAL_SERVER_URL = getConfig('SIGNAL_URL', getWebsocketUrlFromLocation());
